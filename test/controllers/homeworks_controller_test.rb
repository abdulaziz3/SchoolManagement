...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { description: @homework.description, homework_name: @homework.homework_name, marking: @homework.marking, subject_id: @homework.subject_id, user_id: @homework.user_id }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { description: @homework.description, homework_name: @homework.homework_name, marking: @homework.marking, subject_id: @homework.subject_id, user_id: @homework.user_id }
    assert_redirected_to homework_path(assigns(:homework))
  end
