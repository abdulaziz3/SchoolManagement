...
class StudentAttendancesControllerTest < ActionController::TestCase
  ...
  test "should create student_attendance" do
    assert_difference('StudentAttendance.count') do
      post :create, student_attendance: { attendance_description_id: @student_attendance.attendance_description_id, date: @student_attendance.date, student_id: @student_attendance.student_id }
    end
  ...
  test "should update student_attendance" do
    patch :update, id: @student_attendance, student_attendance: { attendance_description_id: @student_attendance.attendance_description_id, date: @student_attendance.date, student_id: @student_attendance.student_id }
    assert_redirected_to student_attendance_path(assigns(:student_attendance))
  end
